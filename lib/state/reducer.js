...
var move = function move(_ref) {
  ...
  var client = function () {
    ...
    var result = {
      ...
      borderBoxCenter: (0, _position.add)(offset, initial.client.borderBoxCenter)
    };
    return result;
  }();
  ...
  var page = {
    ...
    borderBoxCenter: (0, _position.add)(client.borderBoxCenter, currentWindowScroll)
  };
...
exports.default = function () {
  ...
  if (action.type === 'COMPLETE_LIFT') {
    ...
    var page = {
      ...
      borderBoxCenter: (0, _position.add)(client.borderBoxCenter, _viewport.scroll)
    };
  ...
  if (action.type === 'MOVE_FORWARD' || action.type === 'MOVE_BACKWARD') {
    ...
    var _result = (0, _moveToNextIndex2.default)((0, _extends7.default)({
      droppable: droppable,
      previousPageBorderBoxCenter: previousPageBorderBoxCenter
    }, params)) || (0, _extends7.default)({
      scrollJumpRequest: null
    }, (0, _moveCrossAxis2.default)((0, _extends7.default)({
    ...
    var clientBorderBoxCenter = (0, _position.subtract)(_result.pageBorderBoxCenter, _drag4.current.viewport.scroll);
  ...
  if (action.type === 'CROSS_AXIS_MOVE_FORWARD' || action.type === 'CROSS_AXIS_MOVE_BACKWARD') {
    ...
    var _client2 = (0, _position.subtract)(_page, _current2.viewport.scroll);
