(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tiny-invariant'), require('css-box-model'), require('react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'tiny-invariant', 'css-box-model', 'react'], factory) :
	(factory((global.ReactBeautifulDnd = {}),global.invariant,null,global.React));
}(this, (function (exports,invariant,cssBoxModel,React) { 'use strict';
...
var moveCrossAxis = (function (_ref) {
  var isMovingForward = _ref.isMovingForward,
      ...
      previousImpact = _ref.previousImpact,
      viewport = _ref.viewport,
      oppositeAxis$$1 = _ref.oppositeAxis;

  var draggable = draggables[draggableId];
  var source = droppables[droppableId];

  var axis = oppositeAxis$$1 ? oppositeAxis(source.axis) : source.axis;
...
var reducer = (function () {
  ...
  if (action.type === 'MOVE_FORWARD' || action.type === 'MOVE_BACKWARD') {
    ...
    var previousPageBorderBoxCenter = _current.page.borderBoxCenter;
    var _home = {
    ...
    var _result = moveToNextIndex(_extends$2({
      droppable: droppable,
      previousPageBorderBoxCenter: previousPageBorderBoxCenter
    }, params)) || _extends$2({
      scrollJumpRequest: null
    }, moveCrossAxis(_extends$2({
    ...
    var clientBorderBoxCenter = subtract(_result.pageBorderBoxCenter, _drag4.current.viewport.scroll);
  ...
  if (action.type === 'CROSS_AXIS_MOVE_FORWARD' || action.type === 'CROSS_AXIS_MOVE_BACKWARD') {
    ...
    var _drag5 = state.drag;
    if (!_drag5) {
      return clean();
    }

    var _droppableId = function () {
      if (_drag5.impact.destination) {
        return _drag5.impact.destination.droppableId;
      }

      return _drag5.initial.descriptor.droppableId;
    }();

    var _current2 = _drag5.current;
    var _descriptor2 = _drag5.initial.descriptor;
    var _draggableId = _descriptor2.id;
    var pageBorderBoxCenter = _current2.page.borderBoxCenter;
    var _home2 = {
    ...
    var _client2 = subtract(_page, _current2.viewport.scroll);
...
var Draggable = function (_Component) {
  ...
  function Draggable(props, context) {
    ...
    _this.getProvided = memoizeOne(function (isDragging, isDropAnimating, shouldAnimateDisplacement, dimension, dragHandleProps, movementStyle) {
      ...
      var draggableStyle = function () {
        ...
        invariant_1(dimension, 'draggable dimension required for dragging');
  ...
  Draggable.prototype.throwIfCannotDrag = function throwIfCannotDrag() {
    invariant_1(this.state.ref, 'Draggable: cannot drag as no DOM node has been provided');
    invariant_1(!this.props.isDragDisabled, 'Draggable: cannot drag as dragging is not enabled');
  };

  Draggable.prototype.getPlaceholder = function getPlaceholder() {
    var dimension = this.props.dimension;
    invariant_1(dimension, 'cannot get a drag placeholder when not dragging');
